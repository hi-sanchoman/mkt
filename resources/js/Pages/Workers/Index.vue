...
<div class="flex flex-col h-full">
    ...
    <div class="w-full bg-white rounded-2xl  h-auto p-6 overflow-y-auto pt-2">
        <table class="w-full whitespace-nowrap  ">
            ...
            <tr v-for="worker in myworkers" class="text-center hover:bg-gray-100 focus-within:bg-gray-100 mb-3" :key="worker.id">
                ...
                <td class="px-6 pt-3 pb-3 w-8">
                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" @click="editWorker(worker)">Редактировать</button>
...
export default {
    ...
    methods: {
        ...
        editWorker(worker) {
            ...
            this.form.surname = worker.surname;
            this.form.salary = worker.salary;
        },
        ...
        update() {
            ...
            axios.put('workers/' + this.form.id, { id: this.form.id, form: this.form }).then((response) => {
