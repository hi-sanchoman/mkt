...
/* harmony import */ var _Shared_SelectInput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/Shared/SelectInput */ "./resources/js/Shared/SelectInput.vue");
/* harmony import */ var _Shared_TextInput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/Shared/TextInput */ "./resources/js/Shared/TextInput.vue");
/* harmony import */ var _Shared_MonthPicker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/Shared/MonthPicker */ "./resources/js/Shared/MonthPicker.vue");
/* harmony import */ var _Pages_Orders_Nakladnaya_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/Pages/Orders/Nakladnaya.vue */ "./resources/js/Pages/Orders/Nakladnaya.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    MonthPicker: _Shared_MonthPicker__WEBPACK_IMPORTED_MODULE_6__["default"],
    Nakladnaya: _Pages_Orders_Nakladnaya_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  props: {
    realizators: Array,
    pivotPrices: Array,
  ...
  methods: {
    ...
    loadTable: function loadTable() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("realizator-order", data).then(function (response) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("report-avans", {
          id: _this.myreal.id
        }).then(function (resp) {
    ...
    deleteNak: function deleteNak(nak) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]('/naks/' + nak.id + '/delete').then(function (response) {
        location.reload();
      });
    },
    ...
    saveRealization: function saveRealization() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('save-realization', data).then(function (response) {
        alert(response.data.message);
    ...
    saveConfirmRealization: function saveConfirmRealization() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('confirm-realization', data).then(function (response) {
    ...
    exportAvansReport: function exportAvansReport() {
      var merges = [{
        s: 'B1',
        e: 'C1'
      }, {
        ...
        s: 'E34',
        e: 'F34'
      } // если добавят ассортимент сдвинется
      ];
      var realizator = this.getRealizator(this.myreal.realizator);
      var date = moment__WEBPACK_IMPORTED_MODULE_1___default()(new Date(this.myreal.created_at)).format('DD.MM.YYYY HH:mm');
      this.exportExcel(this.dataAvansReportWithNakColums(), merges, 'Авансовый отчет - ' + realizator.first_name + ' от ' + date, 'Авансовый отчет', [realizator.first_name, "Дата", " ", date, " ", " ", " "]);
    },
    // Private: Сформировать данные отчета для экспорта
    dataAvansReportWithNakColums: function dataAvansReportWithNakColums() {
      var data = this.avansReportData;
    ...
    exportExcel: function exportExcel(jsonData, merges, fileName, sheetName, firstLine) {
      var myFile = fileName + ".xlsx";
      var myWorkSheet = XLSX.utils.json_to_sheet(jsonData);
      var merges = myWorkSheet['!merges'] = merges; // [{ s: 'A1', e: 'AA1' }];

      XLSX.utils.sheet_add_aoa(myWorkSheet, [firstLine], {
        origin: 'A1'
      });
              ...
              ? _c(
                  "button",
                  {
                    ...
                    class: _vm.avansReportLoading
                      ? "bg-gray-500"
                      : "bg-blue-500",
                    on: { click: _vm.exportAvansReport },
                  },
                  [
                    _vm._v("\n            Cкачать отчет    "),
